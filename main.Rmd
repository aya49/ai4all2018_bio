...
while (sum(!nodes%in%strains)>0) {
  ...
  # if we haven't reached the leaf nodes yet, continue going deeper into the tree
  # otherwise, find parent strain with date earlier than children and is closest to children
  if (any(!children%in%strains)) {
    ...
    dm_colind = which(dates_unkn < min_date & dates_unkn > min_date_ &
